...
INSERT INTO myapp.user_tbl (user_id, user_firstname, user_lastname, user_emaill, user_password) 
VALUES (UPPER(1126704240), UPPER('Mariana'), UPPER('Hernandez'), 'hernandezjessika777@gmail.com',
